 ...
 */
@ParallelTestClass
public class ParallelTestClass0 {
    
    @Test
    public void fib50a(){
        System.out.println("Starting ParallelTestClass0.testfib50a...");
        long result = Operations.fibonacci(45);
        Assert.assertEquals(1134903170L, result);
        System.out.println("Ending ParallelTestClass0.testfib50a...");
    }
    
    @Test
    public void fib50b(){
        System.out.println("Starting ParallelTestClass0.testfib50b...");
        long result = Operations.fibonacci(45);
        Assert.assertEquals(1134903170L, result);
        System.out.println("Ending ParallelTestClass0.testfib50b...");
    }
}
